  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="card card-primary">
        <form role="form" id="add-category" action="{{ route('manage-lead-save') }}" name="add-category" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea name="address" id="address" cols="60" rows="5" class="form-control" placeholder="Please enter Lead address"></textarea>
            </div>
            <div class="form-group">
