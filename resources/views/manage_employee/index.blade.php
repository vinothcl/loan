  ...
  <div class="row">
    <div class="col-lg-12 col-12">
      ...
      <div class="table-responsive">
        <div class="offset-8 col-sm-4 text-right" style="padding: 10px;"><a href="{{ route('manage-employee-add') }}" class="btn btn-info btn-sm">Add employee</a></div>
...
$(document).ready(function() {
  $('#manage-employee').DataTable({
    ...
    "aaSorting": [],
    "order": [[ 0, "desc" ]],
    "ajax": "{{ route('getemployeeListAjax') }}",
    "columns": thData
  });
        ...
        $.ajax({
                  ...
                  success: function (data) {
                    if(data){
                      ...
                      $('#manage-employee').DataTable().draw();
                    }
                  }
              });
        }
